...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Пользователь с таким именем уже существует' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Неверный пароль или пользователь не существует' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Профиль получен' }),
